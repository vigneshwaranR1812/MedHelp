                ...
                %>
                      ...
                      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
                                        <div id="container2">
                                        	...
                                        	<p class="information">Deliverer Name: <%=rs.getString("name")%></p>
                                        	<p class="information">Age: <%=rs.getInt("age")%></p>
                                        	<p class="information">Gender: <%=rs.getString("gender")%></p>
                                        	<p class="information">Phone number: <%=rs.getString("phno")%> </p>
